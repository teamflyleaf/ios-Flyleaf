//
//  CheckInWishTicketViewController.swift
//  Wishlist
//
...
public final class CheckInWishTicketViewController: BaseViewController {
  public var onRoute: ((CheckInWishTicketRoute) -> Void)?
  
  private let viewModel: CheckInWishTicketViewModel
  
  // 중복 실행 방지를 위한 변수
  private var hasStartedAnimation = false
  
  public init(viewModel: CheckInWishTicketViewModel) {
...
// MARK: - Private
private extension CheckInWishTicketViewController {
