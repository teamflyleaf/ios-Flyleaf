//
//  RegisterJourenyViewModel.swift
//  Journey
//
...
public final class RegisterJourenyViewModel {
...
// MARK: - Private
private extension RegisterJourenyViewModel {
  func validateBookStepNextButton() {
    let isEnabled = startDate != nil && (currentPage ?? 0) > 0
